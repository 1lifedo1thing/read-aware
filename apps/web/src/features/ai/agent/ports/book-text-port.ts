...
export function createBookTextPort(): BookTextPort {
  ...
  return {
    preparation: { start: domain.commands.books.prepareText, get: library.getTextTask, list: library.listTextTasks, pause: domain.commands.books.pauseTextTask, resume: domain.commands.books.resumeTextTask, cancel: domain.commands.books.cancelTextTask },

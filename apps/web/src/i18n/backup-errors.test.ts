...
import { AppError, ERR_BACKUP_INCOMPLETE, ERR_BACKUP_CHANGED, ERR_BACKUP_CANCELLED } from "@read-aware/core";
...
test("backup failures have localized reasons and honest retry semantics without raw details", async () => {
  const cases = [[ERR_BACKUP_INCOMPLETE, "backupIncomplete", false], [ERR_BACKUP_CHANGED, "backupChanged", true], [ERR_BACKUP_CANCELLED, "backupCancelled", false]] as const;

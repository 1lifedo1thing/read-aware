const en = { undo: "Undo profile application", undone: "Profile application undone", title: "Workspace Profiles", save: "Save current workspace", name: "Name", invalid: "Enter a name of 1-80 characters.",
  empty: "No saved profiles", apply: "Apply", remove: "Delete profile", refresh: "Refresh", saved: "Profile saved", applied: "Profile applied",
  conflict: "The profile or settings changed. Refresh before trying again.", missing: "Profile no longer exists", invalidProfile: "Invalid profile",
...
const zh: typeof en = { undo: "撤销应用预设", undone: "已撤销应用预设", title: "工作区预设", save: "保存当前工作区", name: "名称", invalid: "请输入 1-80 个字符的名称。",
  empty: "暂无预设", apply: "应用", remove: "删除预设", refresh: "刷新", saved: "预设已保存", applied: "预设已应用",
  conflict: "预设或设置已变化，请刷新后再试。", missing: "预设已不存在", invalidProfile: "无效预设",

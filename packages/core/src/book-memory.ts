...
export type BookDigestSnapshot = { bookId: string; chapterIndex: number; flavor: DigestFlavor; revision: string; contentVersion?: string | null };
...
export type BookGraphResult = { fence?: string } & (
  ...
  | { graph: "chapter"; contentVersion?: string; chapterIndex: number; chapterHref?: string; summary: string; entities: DigestCharacter[]; relations: DigestRelation[] }

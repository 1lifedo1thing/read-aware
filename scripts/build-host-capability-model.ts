...
<section id="priorities"><h2>当前执行范围</h2><p>仅按 <a href="./host-capability-acceptance.md">C01–C09 集中验收</a> 执行。当前阶段见 <a href="./host-capability-delivery.md">当前交接</a>。本页不维护第二份优先级列表。</p></section>

...
const nativeMap = pairs([
  ...
  ["preferences_load_all", "OPS05"], ["restored_credentials_pending restored_credentials_publish backup_close_reading_sessions backup_export_sources backup_export_capture backup_export_write backup_export_cancel", "OPS08"], ["wipe_all_data", "OPS09"],

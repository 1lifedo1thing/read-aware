...
const agentMap = pairs([
  ...
  ["prepare_book_text get_book_text_tasks set_book_text_task_priority pause_book_text_task resume_book_text_task cancel_book_text_task", "TXT05"],
...
const pluginMap = pairs([
  ...
  ["domains.library.commands.books.prepareText domains.library.commands.books.setTextTaskPriority domains.library.commands.books.pauseTextTask domains.library.commands.books.resumeTextTask domains.library.commands.books.cancelTextTask domains.library.queries.books.getTextTask domains.library.queries.books.listTextTasks domains.library.events.observeTextTask", "TXT05"],

...
const agentMap = pairs([
  ...
  ["list_plugin_schedules", "MORE01"],
  ["manage_plugin_schedule", "MORE01"],
  ["get_software_update", "SYS16"],
  ["verify_local_data", "OPS03 OPS11 SYS15"],
  ["request_projection_repair", "OPS03 OPS11"],
  ...
  ["acquire_resource", "SYS11 SYS06 SYS07 SYS13 LIB08 LIB09"],
  ["resource_directory", "SYS11"],
  ["manage_book_import", "LIB06 SYS11 CON06"],
  ["query_book_imports", "LIB06 CON06 LIB07"],
  ["list_book_formats", "LIB07"],
  ["get_book_enrichment", "LIB09 LIB10"],
  ["get_book_content_state", "LIB14"],
  ["list_duplicate_books", "LIB11"],
  ["preview_book_merge", "LIB11"],
  ["merge_duplicate_books", "LIB11"],
  ["resolve_book_reference", "LIB11"],
  ["retry_book_enrichment", "LIB10"],
  ["manage_resource", "SYS09 SYS13 SYS10 SYS12"],
  ["read_resource_text", "SYS13"],
  ["list_installed_plugins", "EXT11"],
  ["list_plugin_contributions", "EXT11 MORE06"],
  ["open_change_cursor", "CON07 OPS05 SYS02"],
  ["read_changes", "CON07 OPS05 SYS02"],
  ["manage_durable_job", "MORE01 CON03 CON08"],
  ["query_durable_jobs", "MORE01 CON03 CON08"],
  ["preview_atomic_transaction", "CON08 CON02 CON03"],
  ["commit_atomic_transaction", "CON08 CON02 CON03"],
  ["preview_transaction_undo", "CON08 CON02 CON03"],
  ["get_transaction_receipt", "CON08 CON02 CON03"],
  ...
  ["classify_book", "MEM09"],
  ["list_books", "LIB01"],
  ["get_book_overview", "LIB01"],
  ["get_annotations", "ANN01"],
  ["list_collections", "LIB15"],
  ["query_reading_stats", "STAT01 STAT02 STAT03"],
  ["update_book", "LIB02 LIB03 READ19"],
  ["manage_collection", "LIB16 LIB18"],
  ["delete_book", "LIB04"],
  ["delete_books", "LIB05"],
  ["delete_collection", "LIB17"],
  ["list_book_removal_cleanup", "LIB05 LIB13"],
  ["create_annotation", "ANN02 ANN05"],
  ["apply_annotation_changes", "ANN04 ANN05 ANN06 ANN08"],
  ["delete_annotation", "ANN04 ANN05 ANN06"],
  ["search_memory", "MEM01"],
  ["remember", "MEM02"],
  ["manage_memory", "MEM01 MEM04 MEM05"],
  ["query_entities", "MEM08"],
  ["manage_entity", "MEM08"],
  ["manage_book_graph", "MEM10"],
  ["query_conversation", "AI01 MEM12"],
  ["get_toc", "TXT01 TXT02"],
  ["read_chapter", "TXT03"],
  ["search_book_text", "TXT06"],
  ["get_book_text_status", "TXT04"],
  ["manage_book_text_task", "TXT05"],
  ["query_book_text_tasks", "TXT05"],
  ["find_book_locations", "TXT07 TXT13"],
  ["list_book_navigation_targets", "READ05"],
  ["read_book_range", "TXT10 TXT13"],
  ["query_book_references", "TXT11"],
  ["control_book_reference", "TXT11"],
  ["query_book_graph", "MEM11"],
  ["present_books", "AI05"],
  ["open_book", "READ01 READ03"],
  ["get_reading_session", "READ07 TXT09 TXT10 READ13 READ16"],
  ["navigate_reading", "READ02 READ04 READ06 READ16"],
  ["control_read_aloud", "READ18"],
  ["get_host_environment", "MORE03"],
  ["get_operation_availability", "MORE03 AI06 READ16 READ18 TXT05"],
  ["get_host_capabilities", "CON01"],
  ["get_workspace", "UI01 UI02"],
  ["navigate_app", "UI01 UI02"],
  ["list_host_commands", "UI03"],
  ["execute_host_command", "UI03"],
  ["configure_reading_mode", "READ16"],
  ["set_reader_controls", "READ09"],
  ["set_reading_selection", "READ13"],
  ["manage_reading_emphasis", "READ14"],
  ["reader_panels", "READ10 READ11"],
  ["focus_reader", "READ11"],
  ["get_app_window", "SYS17"],
  ["control_app_window", "SYS17"],
  ["get_reader_image", "READ12"],
  ["control_reader_image", "READ12"],
  ["list_book_images", "TXT12"],
  ["open_book_image_resource", "TXT12"],
  ["show_book_image", "TXT12"],
  ["read_book_image", "TXT12"],
  ["get_user_profile", "MEM06"],
  ["reading_action", "SET18 SET19 SET20 SET21"],
  ["inspect_user_profile", "MEM08"],
  ["manage_context_bundle", "MEM13"],
  ["query_context_bundles", "MEM13"],
  ["update_user_profile", "MEM07"],
  ["onboard_reader", "MEM07"],
  ["ask_user", "AI04"],
  ["ask_user_form", "EXT05"],
  ["get_settings", "CFG01"],
  ["update_settings", "CFG01"],
...
const pluginMap = pairs([
  ...
  ["domains.memory.commands.completeOnboarding", "MEM07"],
  ...
  ["domains.library.commands.books.prepareText domains.library.commands.books.setTextTaskPriority domains.library.commands.books.pauseTextTask domains.library.commands.books.resumeTextTask domains.library.commands.books.cancelTextTask domains.library.queries.books.getTextTask domains.library.queries.books.listTextTasks domains.library.queries.books.listTextTaskHistory domains.library.events.observeTextTask", "TXT05"],
  ...
  ["domains.library.commands.books.startImport domains.library.commands.books.cancelImportTask domains.library.queries.books.getImportTask domains.library.queries.books.listImportTasks domains.library.events.observeImportTask", "LIB06 CON06"],
  ...
  ["services.resources.pick services.resources.pickDirectory services.resources.listDirectory services.resources.openDirectoryFile services.resources.releaseDirectory", "SYS11"],
...
const nativeMap = pairs([
  ["web_image_cache_get web_image_cache_put", "SYS13"],
  // Existing device-local API bridge; inventory only, no new Agent permission.
  ["local_api_status local_api_set_enabled", "SYS06 CFG01"],
  ...
  ["desktop_update_check desktop_update_install", "SYS16"], ["set_traffic_lights_visible app_exit_confirm window_input_revision", "SYS17"], ["list_system_fonts", "SYS14"],
...
export function collectInventory(): Inventory[] {
  ...
  for (const point of ["uriHandlers", "commands", "headerActions", "contextActions", "selectionActions", "agentTools"]) {
  ...
  const eventMap = pairs([["reader-demand-activity", "TXT05"],["book-text-changed", "TXT05 MEM11 CON07"],["book-removed library-changed book-changed", "CON07 LIB01"],["plugin-storage-changed local-write-failed", "SYS01 CFG10"],["roaming-preferences-changed", "OPS05"],["projections-invalidated", "CON07 OPS05"],["conversations-changed", "AI01 OPS05"]]);
  ...
  const domainMap = pairs([
    ["backup.restoreChunk backup.restored", "OPS08"],
    ...
    ["profile.updated entity.resolved entity.merged", "MEM08"],["profile.onboarded", "MEM07"],["memory.promoted", "MEM02 MEM03"],
  ...
  const expectedPlugins = pairs([["dictionary", "EXT09 AI12 READ07 LIB01"],["rss-reader", "EXT10"],["editorial-themes", "EXT08"],["sentence-reader", "READ15 READ16"],["tts", "READ17 READ18"],["webdav-sync", "OPS04"],["jumper", "TXT02 TXT07 READ06 EXT02"]])
  // 2026-09-16 rewrites: Jumper dropped its separate navigation module. 2026-09-19: Workspace Profiles was removed outright; 2026-09-21: Reading Goals and Annotations followed (evidence only in Git history).
  expectedPlugins["jumper"] = ["TXT02", "TXT07", "READ01", "READ05", "READ06", "READ07", "READ13", "EXT02", "SYS02", "AI05"];

...
const agentMap = pairs([
  ...
  ["pick_resource_files pick_resource_directory list_resource_directory open_directory_resource release_resource_directory", "SYS11"],
  ["download_resource", "SYS06 SYS07 SYS13"],
  ["import_resource_book", "LIB06 SYS11"],
  ["get_book_import_tasks cancel_book_import_task", "LIB06 CON06"],
  ...
  ["prepare_book_text get_book_text_tasks get_book_text_task_history set_book_text_task_priority pause_book_text_task resume_book_text_task cancel_book_text_task", "TXT05"],
  ...
  ["list_book_images open_book_image_resource show_book_image read_book_image", "TXT12"],
...
export function collectInventory(): Inventory[] {
  ...
  const expectedPlugins = pairs([["dictionary", "EXT09 AI12 READ07 LIB01"],["rss-reader", "EXT10"],["editorial-themes", "EXT08"],["sentence-reader", "READ15 READ16"],["tts", "READ17 READ18"],["webdav-sync", "OPS04"],["jumper", "TXT02 TXT07 READ06 EXT02"],["annotations", "ANN01 ANN04 ANN05 ANN08 ANN09 EXT02 EXT05 SYS10"],["reading-goals", "AI11 MEM03 CFG01 EXT07 EXT02 EXT05 SYS01 SYS02"],["workspace-profiles", "UI02 CFG01 EXT02 EXT05 SYS02"]])
  // 2026-09-16 rewrites: Reading Goals dropped its reading-time/insights pages, Workspace Profiles its window/font/shortcut/current-workspace surfaces, Jumper its separate navigation module.

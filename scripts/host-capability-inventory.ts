...
export function collectInventory(): Inventory[] {
  ...
  const expectedPlugins = pairs([["dictionary", "EXT09 AI12 READ07 LIB01"],["rss-reader", "EXT10"],["editorial-themes", "EXT08"],["sentence-reader", "READ15 READ16"],["tts", "READ17 READ18"],["webdav-sync", "OPS04"],["jumper", "TXT02 TXT07 READ06 EXT02"],["annotations", "ANN01 ANN04 ANN05 ANN08 ANN09 EXT02 EXT05 SYS10"],["reading-goals", "AI11 MEM03 CFG01 EXT07 EXT02 EXT05 SYS01 SYS02"]])
  // 2026-09-16 rewrites: Reading Goals dropped its reading-time/insights pages, Jumper its separate navigation module. 2026-09-19: Workspace Profiles was removed outright (evidence only in Git history).

...
Specialized contracts: [resource limits](./resource-limits.md),
[deferred tasks](./plugin-deferred-tasks.md), [identity and profile](../architecture/identity-and-profile.md),
[context bundles](../architecture/context-bundles.md).

## Navigation

[Documentation index](../README.md) · [Human-facing summary](./plugin-system.html)

- [1. The Model](#1-the-model)
- [2. Boundary Test](#2-boundary-test)
- [3. Canonical Sources](#3-canonical-sources)
- [4. Actor-Scoped Runtime](#4-actor-scoped-runtime)
- [5. Domains](#5-domains)
- [6. Settings Is a Domain](#6-settings-is-a-domain)
- [7. Contributions](#7-contributions)
- [8. Host Services](#8-host-services)
- [9. Permissions](#9-permissions)
- [10. Capability Versions](#10-capability-versions)
- [11. Declarative UI](#11-declarative-ui)
- [12. Lifecycle](#12-lifecycle)
- [13. First-Party Coverage](#13-first-party-coverage)
- [14. Extension Procedure](#14-extension-procedure)
- [15. Verification Contract](#15-verification-contract)
...
[implementation and desktop evidence](../capabilities/host-capability-delivery.md).
...
unverified. See [delivery evidence](../capabilities/host-capability-delivery.md).

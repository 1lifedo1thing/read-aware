...
| READ03 | 按章节/标注/href/CFI 跳转 | F3 | 本机FB2 Jumper/Agent原文CFI及PDF Worker跳转/缺失href/旧源拒绝通过；其他目标/格式待验，见第二十二流程 |
...
| SYS17 | 窗口最小化/最大化/全屏/关闭/标题栏 | F8 | 编译Workspace Profiles最大化/最小化/还原：原生flag与Worker实时显示通过；补destroy权限后debug正常关闭/重启、release包原生关闭按钮/退出通过；全屏/标题栏其余行为待验，见第二十七/三十一流程 |

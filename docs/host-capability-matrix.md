...
- 宿主：实装 206、部分 35、非桌面 1、待建 1。
- Agent：接通 150、部分 42、扩展 11、接通（待 E2E） 14、自动 13、未接 13。
- 插件：接通 165、部分 57、接通（待 E2E） 16、未接 5。

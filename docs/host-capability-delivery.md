...
真实桌面已新增四十六组组合证据：正文准备/历史、图片脚注、RSS缓存及重排、
...
配置/凭据/备份键/合成书/Worker/偏好已清理恢复，19843服务已停。下一批优先
补buildMemory/followStreaming及AI配置；读取中换源等正文边界保持待验；前台恢复后
接续复制、菜单编辑器、聊天消息字体和未覆设置呈现。全格式/跨平台/跨设备及

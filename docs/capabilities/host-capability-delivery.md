...
更新时间：2026-09-19。清理前完整流水账保留在 Git 对象 `17860738`。
...
- 2026-09-19：Workspace Profiles 插件整体移除（源码、桌面探针与组合夹具一并删除）。
  矩阵中 UI02/CFG01/SYS02/CON08 等行的插件消费者改记为“无第一方插件消费者”，
  C07 的安装态预设场景随之退役；宿主能力本身未回退，插件侧证据只在 Git 历史中。
